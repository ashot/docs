...
These token limits are applicable across all premium plans.

### **Flex Pricing**

The Flex plan is an add on designed for users who need more volume than the Plus or Pro plans can provide. It offers a pay-as-you-go pricing model for all models at cost beyond capacity.
