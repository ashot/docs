...
2. **Command-K Menu**: A universal shortcut, Command-K, brings up a powerful search menu that lets you navigate to any part of the app instantly, including starting new chats, switching models, or inviting teammates.
...
4. **AI Model Selection**: Easily switch between AI models to utilize the one that best suits the task at hand. Each model has unique strengths, and Vello allows for seamless transition. + Mentions
