...
6. **Writing Mode for Longer Responses**: When you need to provide structured information to the AI, use writing mode by pressing `Option+W`. This opens a resizable editor window that allows you to write longer documents in markdown to submit them all at once by pressing `Option+Enter`.  Change the orientation of the editor by pressing `Option+Shift+W`.
