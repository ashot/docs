...
### **Vello Plus**
<img src="/images/plus.png" alt="plus" width="100"/>
For $17 per month, this plan offers generous access to all models and daily use of premium features, including:
...
### **Vello Pro**
<img src="/images/pro.png" alt="pro" width="100"/>
Priced at $29 per month, our Pro plan provides unlimited access to all models and premium features, plus prioritized support. It includes:
...
### **Vello Flex**
<img src="/images/flex.png" alt="flex" width="100"/>
- Optional add on enables pay as you go pricing for all premium models beyond capacity.
- Currently in beta, Flex offers a flexible pricing model for users who need more than the Plus or Pro plans can provide.
- [Pricing](/models#flex-pricing) varies by model and usage.

### **Vello Team**
<img src="/images/team.png" alt="team" width="100"/>
At $39 per month, the Team plan extends the Pro benefits to your entire team. This includes:
- Everything in Vello Pro for each team member
- Unlimited Team AI Personas
- Unlimited Team Files & Documents

**Vello Enterprise**: For enterprise-level needs, Vello offers custom plans tailored to your organization’s requirements, white labeling, company knowledge ingestion from your work tools and more. [Contact us](mailto:hello@vello.ai) to learn more about our Enterprise plan.

\* *Pro plan has hourly and monthly limits to prevent abuse, but these are set high enough that they shouldn’t affect normal usage.*
...
**What happens after the free trial ends?** Once the trial time period is over, your plan will activate to premium, but you can also cancel at anytime. If you want to continue with a premium plan before the end of the trial period choose `Activate Paid Plan` in your plan settings, this will remove the free trial limit and start your paid plan instantly.

**Are there any usage limits on the Plus and Pro plans?**
Our limits are somewhat variable and subject to change, but the Plus plan has a weekly limit of approximately 500 calls per model, designed to be generous for most users. The Pro plan is built to offer effectively unlimited access for a single user’s normal use. There are some hourly limits to prevent abuse, but these are set high enough that they shouldn’t affect normal usage.

**What happens if I reach my plan’s limit?**
Limits are put in place to ensure fair usage and system stability. If you reach your limit, you may need to wait until your limit resets, switch to a different model, or consider upgrading to a plan with a higher limit. 
